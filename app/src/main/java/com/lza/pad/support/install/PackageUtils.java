package com.lza.pad.support.install;
 ...
 * <li>{@link com.lza.pad.support.install.PackageUtils#installNormal(android.content.Context, String)}</li>
 * <li>{@link com.lza.pad.support.install.PackageUtils#installSilent(android.content.Context, String)}</li>
 * <li>{@link com.lza.pad.support.install.PackageUtils#install(android.content.Context, String)}</li>
 * </ul>
 * <ul>
 * <strong>Uninstall package</strong>
 * <li>{@link com.lza.pad.support.install.PackageUtils#uninstallNormal(android.content.Context, String)}</li>
 * <li>{@link com.lza.pad.support.install.PackageUtils#uninstallSilent(android.content.Context, String)}</li>
 * <li>{@link com.lza.pad.support.install.PackageUtils#uninstall(android.content.Context, String)}</li>
 * </ul>
 * <ul>
 * <strong>Is system application</strong>
 * <li>{@link com.lza.pad.support.install.PackageUtils#isSystemApplication(android.content.Context)}</li>
 * <li>{@link com.lza.pad.support.install.PackageUtils#isSystemApplication(android.content.Context, String)}</li>
 * <li>{@link com.lza.pad.support.install.PackageUtils#isSystemApplication(android.content.pm.PackageManager, String)}</li>
 * </ul>
 * <ul>
 * <strong>Others</strong>
 * <li>{@link com.lza.pad.support.install.PackageUtils#getInstallLocation()} get system install location</li>
 * <li>{@link com.lza.pad.support.install.PackageUtils#isTopActivity(android.content.Context, String)} whether the app whost package's name is packageName is on the
 * top of the stack</li>
 * <li>{@link com.lza.pad.support.install.PackageUtils#startInstalledAppDetails(android.content.Context, String)} start InstalledAppDetails Activity</li>
 * </ul>
 * 
...
public class PackageUtils {
     ...
     * @param context
     * @param filePath file path of package
     * @return {@link com.lza.pad.support.install.PackageUtils#INSTALL_SUCCEEDED} means install success, other means failed. details see
     *         {@link com.lza.pad.support.install.PackageUtils}.INSTALL_FAILED_*. same to {@link android.content.pm.PackageManager}.INSTALL_*
