 ...
 */
@Deprecated
public class _PadDeviceInfo implements Parcelable {
    ...
    private _PadDeviceInfo(Parcel in) {
    ...
    public static final Creator<_PadDeviceInfo> CREATOR = new Creator<_PadDeviceInfo>() {
        public _PadDeviceInfo createFromParcel(Parcel source) {
            return new _PadDeviceInfo(source);
        }

        public _PadDeviceInfo[] newArray(int size) {
            return new _PadDeviceInfo[size];
        }
    };
}
