 ...
 * @Date 3/13/15.
 */
public class PadWidget implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.parse_code);
    }

    public PadWidget() {
    }

    private PadWidget(Parcel in) {
        ...
        this.parse_code = in.readString();
    }

    public static final Parcelable.Creator<PadWidget> CREATOR = new Parcelable.Creator<PadWidget>() {
        public PadWidget createFromParcel(Parcel source) {
            return new PadWidget(source);
        }

        public PadWidget[] newArray(int size) {
            return new PadWidget[size];
        }
    };
}
