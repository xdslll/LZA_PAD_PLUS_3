...
public class _DownloadHelper {
     ...
     * @param file
     */
    public _DownloadHelper(Context ctx, PadVersionInfo version, String fileName, File file) {
        this(ctx, version.getUrl(), fileName, file.getAbsolutePath(), PadVersionInfo.FILE_TYPE);
    }

    public _DownloadHelper(Context ctx, String url, String fileName, String filePath, int fileType) {
    ...
    public _DownloadHelper(Context ctx, InternelDownloadFile downloadFile) {
        this(ctx, downloadFile.getUrl(), downloadFile);
    }

    public _DownloadHelper(Context ctx, String url, InternelDownloadFile downloadFile) {
        mDownloadUrl = url;
        mCtx = ctx;
