...
public class _RequestHelper implements Consts {
    ...
    private _RequestHelper(Context c, String requestUrl) {
        this.mCtx = c;
    ...
    private static _RequestHelper sInstance = null;

    public static _RequestHelper getInstance(Context c) {
        if (sInstance == null) {
            sInstance = new _RequestHelper(c);
        }
        return sInstance;
    }

    public static _RequestHelper getInstance(Context c, String requestUrl) {
        if (sInstance == null) {
            sInstance = new _RequestHelper(c, requestUrl);
        }
        return sInstance;
    }
