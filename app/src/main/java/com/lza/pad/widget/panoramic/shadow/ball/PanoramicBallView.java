...
import com.lza.pad.widget.panoramic.shadow.glutils.TimGL2Utils;
...
public class PanoramicBallView implements Renderer {
	Context mContext;
	...
	public PanoramicBallView(Context context) {
		this(context, 0);
	}

    public PanoramicBallView(Context context, int index) {
        mContext = context;
        this.index = index;
        init();
    }
	...
	public void onSurfaceChanged(GL10 gl, int width, int height) {
        ...
        if (index == 0) {
            textrueID = TimGL2Utils.initTexture(mContext, R.drawable.test_p1);
        } else if (index == 1) {
            textrueID = TimGL2Utils.initTexture(mContext, R.drawable.test_panoramic_p1);
        } else if (index == 2) {
            textrueID = TimGL2Utils.initTexture(mContext, R.drawable.test_p4);
        } else if (index == 3) {
            textrueID = TimGL2Utils.initTexture(mContext, R.drawable.test_p3);
        }
